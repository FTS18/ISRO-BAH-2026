...
- **Respect Existing Patterns & Dependencies**: Maintain complete consistency with existing codebase design patterns, styling, and helper architectures. Do not introduce new library dependencies unless explicitly requested.
...
- **No Emojis**: Do not use emojis in code, commits, pull requests, rules, or user communication.
